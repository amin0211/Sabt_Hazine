...
def build_chat_ui(
    ...
    top_bar = ft.Container(
        bgcolor=card_color,
        padding=ft.padding.only(left=16, top=18, right=16, bottom=14),
                ...
                ft.Row(
                    [
                        ft.Container(
                            ...
                            content=ft.Icon(ft.Icons.ACCOUNT_BALANCE_WALLET_ROUNDED, color=PRIMARY),
                        ),start_btn, end_btn
                    ],
